...
public final class Constants {
  ...
  public static class DrivetrainConstants {
    // TODO Tune the PIDs
    public static final Slot0Configs driveMotorPIDF = new Slot0Configs().withKP(0).withKI(0).withKD(0).withKV(0);
    public static final Slot0Configs turnMotorPIDF = new Slot0Configs().withKP(0).withKI(0).withKD(0).withKV(0);
    // TODO find the slip current
