...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        .withKP(80).withKI(0).withKD(0.8)
        .withKS(0.1).withKV(1.59).withKA(0)
        .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
    // When using closed-loop control, the drive motor uses the control
    // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
    private static final Slot0Configs driveGains = new Slot0Configs()
        .withKP(0.094687).withKI(0).withKD(0)
        .withKS(0.18578).withKV(0.11269);
    ...
    private static final Current kSlipCurrent = Amps.of(120.0);  // TODO Find slip current
    ...
    public static final CANBus kCANBus = new CANBus("CANivore_1", "./logs/example.hoot");

    // Theoretical free speed (m/s) at 12 V applied output;
    // This needs to be tuned to your individual robot
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(5.21);  // TODO check the max theoretical speed

    // Every 1 rotation of the azimuth results in kCoupleRatio drive motor turns;
    // This may need to be tuned to your individual robot
    private static final double kCoupleRatio = 3.5714285714285716;

    private static final double kDriveGearRatio = 6.12;//6.122448979591837;
    private static final double kSteerGearRatio = 12.8;
    private static final Distance kWheelRadius = Inches.of(3.927/2);
    ...
    private static final MomentOfInertia kDriveInertia = KilogramSquareMeters.of(8.535);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(0.18017578125);
